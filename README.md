...
- [`docs/architecture.md`](docs/architecture.md) — Stack y estructura del proyecto (backend y frontend)
- [`docs/project-description.md`](docs/project-description.md) — Descripcion completa, objetivos y alcance
- [`docs/modelo-de-datos.md`](docs/modelo-de-datos.md) — Modelo de datos y entidades
- [`docs/modules/`](docs/modules/) — Especificacion funcional de cada modulo (01 a 06)
- [`docs/laboratorios-alumno.md`](docs/laboratorios-alumno.md) — Flujo de exploracion por laboratorio (vista alumno)
